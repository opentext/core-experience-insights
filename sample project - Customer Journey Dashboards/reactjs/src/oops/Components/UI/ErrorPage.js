...
class ErrorPage extends Component {
    ...
    render() {
        ...
        const errorType = (match && match.params) ? match.params.errorType : 'user.nosubscription'
        return (
            <Container fluid={true} className="homepage" role='main'>
                ...
                {errorType !== '503' && <Row className='error-buttons'>
                    <Col className='d-flex justify-content-end'>
                        <div className='mr-4'>
                            <div className='error-back-icon' onClick={()=> match.history.go(-1)}>
                            </div>
                            <div className='error-icon-message' onClick={()=> match.history.go(-1)}>
